...
class B2BServer(ThreadingHTTPServer):
    ...
    def __init__(self, server_address, handler_class):
        ...
        self.admin_password = os.getenv("ADMIN_PASSWORD", "CtaCustos#2026!")
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def _activities(self, query: dict[str, list[str]]) -> None:
        try:
                ...
                activities = [
                    ...
                    if text in " ".join(
                        ...
                        for key in (
                            ...
                            "empresa", "tecnico_nome", "matricula", "eps",
                        )
                    ).casefold()
                ]
            if status:
            ...
            allowed_sorts = {"id", "tipo_atividade", "status", "situacao", "atualizado_em", "custo_total", "gap"}
