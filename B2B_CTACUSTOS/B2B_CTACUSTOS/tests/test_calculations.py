...
class CalculationTests(unittest.TestCase):
    ...
    def test_summary_uses_calculated_values(self):
        rows = [
            {"status": "Concluída", "tipo_atividade": "A", "custo_total": 100, "custo_evitado": 180, "gap": 80},
            {"status": "Em andamento", "tipo_atividade": "B", "custo_total": 90, "custo_evitado": 120, "gap": 30},
        ]
    ...
    def test_sample_workbook_can_be_read_and_updated(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            shutil.copy2(PROJECT / "data" / "B2B_CTACUSTOS.xlsx", copy)
    ...
    def test_include_preserves_row_style_and_extends_excel_table(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(sheet.tables["AtividadesTable"].ref, "A1:M3")
    ...
    def test_settings_catalogs_are_saved_and_drive_form_options(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            shutil.copy2(PROJECT / "data" / "B2B_CTACUSTOS.xlsx", workbook_path)
    ...
    def test_reference_workbook_upload_is_saved_beside_main_excel(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            data_dir.mkdir()
            workbook_path = data_dir / "B2B_CTACUSTOS.xlsx"
            source = PROJECT / "data" / "B2B_CTACUSTOS.xlsx"
